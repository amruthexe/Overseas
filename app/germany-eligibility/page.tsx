...
export default function GermanyEligibilityPage() {
  ...
  // Watch fields for custom option card selections to handle active classes dynamically
  ...
  const handleContinue = async () => {
    ...
    // Execute step-specific Zod parse
    const result = currentSchema.safeParse(values);

    if (!result.success) {
      // Map errors back to React Hook Form state
      ...
      // Scroll to the top of the step card to show validation issues
      window.scrollTo({ top: 120, behavior: "smooth" });
      return;
    }

    // Clear validation errors and progress step
  ...
  const onSubmit = async (data: GermanyEligibilityLead) => {
    // Step 5 validation check before submitting final payload
  ...
  // Reusable static arrays for select lists
  const ageOptions = [
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      {/* Sticky Trust header Progress Bar - hidden on Success screen */}
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                {step === 1 && (
                  <StepLayout
                    ...
                    subtitle="We'll use these to schedule your free Germany counselling call."
                  >
                    <div className="space-y-4 md:space-y-5">
                      ...
                      <StepButtons 
                        ...
                        onBack={undefined} // No back button on Step 1
                      />
                    </div>
                  </StepLayout>
                )}
                ...
                {step === 2 && (
                  ...
                  >
                    <div className="space-y-5 md:space-y-6">
                      ...
                      {/* Do you speak English? Toggle Cards */}
                ...
                {step === 4 && (
                  ...
                  >
                    <div className="space-y-5 md:space-y-6">
                      ...
                      {/* What are you looking for selection */}
                      <div className="space-y-2">
                        <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider">
                ...
                {step === 5 && (
                  ...
                  >
                    <div className="space-y-5 md:space-y-6">
                      ...
                      {/* Booking timeline selection cards */}
                      <div className="space-y-2">
                        <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider">
